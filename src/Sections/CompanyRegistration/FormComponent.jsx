...
class FormComponentCompany extends Component {
  state = {
    data: {
      firstName: "",
      lastName: "",
    ...
    steps: [
      { label: "Personal Info" },
      { label: "Educational & Professional Info" },
    ],
    stepCount: 0,
  };
  render() {
...
FormComponentCompany.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(FormComponentCompany);
